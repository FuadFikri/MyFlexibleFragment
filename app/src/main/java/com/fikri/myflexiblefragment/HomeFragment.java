package com.fikri.myflexiblefragment;
...
//     layout interface didefinisikan dan ditransformasikan dari layout berupa file xml ke dalam obyek view dengan menggunakan metode inflate().
    @Override
